...
p1 = Parameters()
p1.add("qsmax", value= 1.3, min= 1, max=5.0 , vary = True)     #Maximum glucose uptake rate [g/(g*h)]   #previous start val: 0.1  #estimated value: 1.61290497
...
p1.add("qO2max", value= 0.16473635, min=0.1, max=0.4, vary = False)    #Maximum oxygen uptake rate [g/(g*h)]  , min=0.1  0.1, 0.4  #previous start val: 0.255984, 1 #estimated value: 0.17451356
...
p1.add("Yxs_ox", value= 0.52792125, min=0.3, max=0.6, vary= False) #Yield biomass per glucose (oxidative growth) [g/g] #previous start val: 49    #estimated value 0.52792125
